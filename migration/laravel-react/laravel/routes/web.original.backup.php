...
// Backup of original routes/web.php before applying staged removals.
// Created by automated migration tooling.
// If you need to restore, replace routes/web.php with this file.
