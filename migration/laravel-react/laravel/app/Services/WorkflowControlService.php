    ...
    public function hasPayrollAndQR(): bool
    {
        $query = "
            SELECT COUNT(*) as total,
                   COUNT(CASE WHEN COALESCE(s.payroll_no::text,'') <> '' THEN 1 END) as with_payroll,
        ...
        try {
            $query = "
                SELECT
                    ...
                    COUNT(CASE WHEN status = 'active' AND COALESCE(payroll_no::text,'') <> '' THEN 1 END) as with_payroll_count,
